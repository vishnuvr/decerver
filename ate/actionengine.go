...
func NewActionEngine(ec *monk.EthChain) *ActionEngine {
	vm := otto.New()
	se := &ActionEngine{otto: vm, ethChain: ec}
...
func (se *ActionEngine) LoadModelFromFile(name, fileName string) {
...
func (se *ActionEngine) RunAction(path []string, fName string, param interface{}) ([]string, error) {
...
func (se *ActionEngine) convertObj(obj interface{}) ([]string, error) {
...
func (se *ActionEngine) convertPath(path []string) string {
...
// The array may be of mixed types, so long as they are strings, booleans or ints.
func (se *ActionEngine) convertParam(param interface{}) (string, error) {
