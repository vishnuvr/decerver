...
function Model(address){
	...
	var _data = {
		// Global
		"offset"  		: "0x10000", // The spacing used to avoid collision of name spaces (contracts, permissions and variables)
		"GFzeros" 		: "0x1000000", // Names used buts end in at least 3 empty bytes in order to partition name spaces
		"colavd" 		: "0x100", // This is used to partition user address space
		// C3D
		"BAindicator" 	: "0x10",
		"BAdmpointer" 	: "0x11",
		"BAUIpointer" 	: "0x12",
		...
		"BALLstart"		: "0x19",
		// LinkedList
		"headslot" 		: this["BALLstart"], //This will keep LLstart at newest element
		"tailslot"  	: "0x20",
		"countslot" 	: "0x22",
		"prowslot"  	: "0x23",
		"pbitslot"  	: "0x24",
	...
	// Methods. These are the base contract methods, no "extra stuff"
	...
	// LinkedList
	function nextlink(params) {
		return GetStorageAt(_address,Add(params,"2"));
	};
	
	function prevlink(params) {
...
//Params: "name", "0xtarget"
GenDoug.prototype.checkperm = function(params) {
...
//Just a test. Params to stick to template. Returns a list of contract names.
GenDoug.prototype.getContracts = function(params) {
	
	var start = GetStorageAt(_address, _data.tailslot);
	if(IsZero(start)){
		return [];
	}
	var contracts = [];
	
	var current = GetStorageAt(_address,start);
